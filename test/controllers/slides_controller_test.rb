...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { description: @slide.description, image_name: @slide.image_name, image_uid: @slide.image_uid, slave: @slide.slave, sort: @slide.sort, title: @slide.title, url: @slide.url }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { description: @slide.description, image_name: @slide.image_name, image_uid: @slide.image_uid, slave: @slide.slave, sort: @slide.sort, title: @slide.title, url: @slide.url }
    assert_redirected_to slide_path(assigns(:slide))
  end
